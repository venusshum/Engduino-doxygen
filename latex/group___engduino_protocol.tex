...
\end{DoxyReturn}
This function will send button state or enables button interrupt, which will immediately sens back any change in button state. Both edges can be configured as an interrupt source.
...
\end{TabularC}
\hypertarget{group___engduino_protocol_gad15fd39a7f4787cf6c8bbfc101df4387}{}\index{Driver for Engduino Protocol@{Driver for Engduino Protocol}!````~Engduino\+Protocol\+Class@{$\sim$\+Engduino\+Protocol\+Class}}
